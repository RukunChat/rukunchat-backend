"""
Django settings for rukunchat project.
...
SECRET_KEY = 'django-insecure-*^$qo98ha9o)xfk^o$7s5uz+3iobcvlsdyw(c4(fn!g-eg$)nn'
...
WSGI_APPLICATION = 'rukunchat.wsgi.application'
